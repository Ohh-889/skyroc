...
/**
 * 落地页访客的第一诉求是「先看看长什么样」，而 hero 的两个 CTA（快速开始 / 查看 Admin 文档）
 * 都通向文档，没人管这件事，所以预览入口放在 header 右侧。
 *
 * v3 管理端是主推的 demo，用 primary 底色；RuoYi 是对接示例，走描边样式，
 * 并在 1020px 以下随中间导航一起收起，避免窄屏右侧堆四个控件。
 *
 * RuoYi 那台是临时云服务器，走 HTTP 且直接暴露公网 IP：链接进了公开首页就会被搜索引擎
