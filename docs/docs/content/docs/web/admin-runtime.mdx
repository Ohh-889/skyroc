...
更完整的多语言接入、资源维护和语言副作用说明见 [`@skyroc/web-admin-i18n`](/docs/web/admin-i18n)。
...
修改 `docs/docs` 文档后，建议执行：

```bash
pnpm --dir docs/docs types:check
...
```bash
pnpm exec oxfmt --check docs/docs/content/docs/web/admin-runtime.mdx docs/docs/content/docs/web/meta.json
```
