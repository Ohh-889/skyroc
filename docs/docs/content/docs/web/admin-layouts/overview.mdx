...
<Cards>
  <Card title="快速接入" href="/docs/web/admin-layouts/quick-start">
    从应用入口、路由布局页和认证守卫开始接入后台壳。
  </Card>
  <Card title="菜单系统" href="/docs/web/admin-layouts/menus">
    先理解菜单统一结构、权限、badge、extra 和 menuNodeCallback。
  </Card>
  <Card title="静态菜单生成" href="/docs/web/admin-layouts/static-menu-generation">
    从 TanStack Router staticData 生成菜单树和快速索引。
  </Card>
  <Card title="动态菜单生成" href="/docs/web/admin-layouts/dynamic-menu-generation">
    从后端路由树生成菜单树，并处理分类、首页和扩展节点。
  </Card>
  <Card title="布局插槽" href="/docs/web/admin-layouts/slots">
    接入 Logo、Header actions、Footer、Content 和多菜单分类。
  </Card>
  <Card title="状态与页签" href="/docs/web/admin-layouts/state-tabs">
