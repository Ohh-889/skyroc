...
| UI         | Ant Design 6、`@skyroc/web-ui*` | `@skyroc/native-ui`        | `@skyroc/ui-types`、`@skyroc/form`                       |
...
文档站不是 Vite 应用。`docs/*` 使用 **Next.js + Fumadocs**，负责主文档、包参考以及 Web / Native UI 的独立文档站。
...
完整的平台目录与包职责见 [目录结构总览](/docs/guide/getting-started/directory) 和 [包参考](/docs/packages)。
...
当你需要进一步确认代码应该放在哪里时，继续阅读 [目录结构总览](/docs/guide/getting-started/directory)；当你需要了解某个包的公开职责和入口时，进入 [包参考](/docs/packages)。
