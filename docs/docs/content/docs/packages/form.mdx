...
| 版本 | 0.0.2 |
| 运行时依赖 | `@radix-ui/react-slot`、[`@skyroc/type-utils`](/docs/packages/shared/type-utils)、[`@skyroc/utils`](/docs/packages/core/utils/overview) |
...
### 2. 路径类型由 [`@skyroc/type-utils`](/docs/packages/shared/type-utils) 驱动
