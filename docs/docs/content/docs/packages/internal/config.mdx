...
| `react.json` | `apps/{admin,admin-example,ruoyi-plus-fast}`、`packages/web/{admin-devtools,admin-layouts,admin-notification,admin-theme,materials}`、`packages/web/ui/{shadcn,antd,compose}`、`packages/@core/scripts/templates/admin` |
