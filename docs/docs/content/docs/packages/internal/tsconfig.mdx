...
| `library.json` | `packages/@core/utils`、`packages/@core/tailwind-plugin`、`packages/shared/type-utils`、`packages/shared/ui-types` |
...
| `web-app.json` | `apps/admin`、`apps/admin-example`、`apps/ruoyi-plus-fast`、`packages/@core/scripts/templates/admin` |
