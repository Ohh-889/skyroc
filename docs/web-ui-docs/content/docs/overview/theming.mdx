...
/* 自定义选择器 */
@import '@skyroc/tailwind-plugin' with (
  ...
  data={[
    {
      ...
      fields: [
        {
          name: 'color',
          type: 'ThemeConfigColor | ThemeCSSVarsVariant | false',
          description: '主题配色方案，支持预设名称、自定义 CSS 变量或禁用。默认 default。'
        },
        { name: 'darkSelector', type: 'string', description: '深色模式选择器。默认 .dark。' },
        { name: 'radius', type: 'number | false', description: '全局圆角大小（rem）。默认 0.5。' },
        {
          name: 'feedbackColor',
          type: 'FeedbackColorOfThemeCssVarsVariant',
          description: '自定义反馈色（success / warning / info / carbon）的亮色和暗色值。'
        },
