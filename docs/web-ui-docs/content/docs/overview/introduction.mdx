...
<Cards>
  <Card
    title="设计系统"
    description="颜色语义、尺寸体系、设计令牌与暗色模式"
  ...
  <Card
    title="场景示例"
    description="官网首页、注册登录、内容列表和订阅表单"
    href="/overview/examples"
  />
  <Card
    title="迁移与约定"
    description="从 shadcn 或自定义 Tailwind 组件迁移时的边界"
