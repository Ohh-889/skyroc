...
/**
 * Class names for different slots in the alert dialog component. Allows customizing styles for specific parts of the
 * alert dialog, including the icon slot.
 */
...
/**
 * Alert type enumeration that restricts theme colors to alert-specific types. Supports destructive, info, success, and
 * warning alert types.
 */
export type AlertType = Extract<ThemeColor, 'destructive' | 'info' | 'success' | 'warning'>;

/** Props for the alert dialog content component. Contains the main content area of the alert dialog. */
export interface AlertDialogContentProps extends StyledComponentProps<_AlertDialogContentProps> {}

/**
 * Props for the alert dialog description component. Provides descriptive text or additional information in the alert
 * dialog.
 */
export interface AlertDialogDescriptionProps extends StyledComponentProps<_AlertDialogDescriptionProps> {}

/** Props for the alert dialog footer component. Container for action buttons or additional footer content. */
export type AlertDialogFooterProps = HTMLComponentProps<'div'>;

/** Props for the alert dialog header component. Container for title, icon, and other header content. */
export type AlertDialogHeaderProps = HTMLComponentProps<'div'>;

/** Props for the alert dialog overlay component. Semi-transparent backdrop that appears behind the alert dialog. */
export interface AlertDialogOverlayProps extends StyledComponentProps<_AlertDialogOverlayProps> {}

/** Props for the alert dialog title component. Displays the primary heading text of the alert dialog. */
export interface AlertDialogTitleProps extends StyledComponentProps<_AlertDialogTitleProps> {}

/**
 * Props for the main AlertDialog component. Combines base Radix UI alert dialog props with custom styling and content
 * options.
 *
 * @example
 *   ```jsx
...
export type AlertDialogProps = StyledComponentProps<_AlertDialogProps> &
  ...
  _AlertDialogPortalProps & {
    ...
    /**
     * Content to display in the footer section (typically action buttons). Set to `null` to hide the default footer
     * buttons. Set to a React node to render custom footer content.
     */
