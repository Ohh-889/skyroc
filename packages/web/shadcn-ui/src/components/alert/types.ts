...
/** Props for the alert description component. Displays supplementary text or details below the alert title. */
export type AlertDescriptionProps = StyledComponentProps<React.ComponentProps<'div'>>;

/**
 * Props for the alert root/wrapper component. Serves as the main container for the alert with color and variant
 * styling.
 */
...
/** Props for the alert title component. Displays the main heading or primary message of the alert. */
export type AlertTitleProps = StyledComponentProps<React.ComponentProps<'div'>>;

/** Props for the alert wrapper component. Contains the overall alert element structure. */
export type AlertWrapperProps = StyledComponentProps<React.ComponentProps<'div'>>;

/** Props for the alert icon component. Displays an icon or visual indicator for the alert type. */
...
/** Props for the alert close button component. Renders a button to dismiss or close the alert. */
export type AlertCloseProps = StyledComponentProps<React.ComponentProps<'button'>>;

/** Class names for different slots in the alert component. Allows customizing styles for specific parts of the alert. */
export type AlertClassNames = Partial<Record<AlertSlots, ClassValue>>;

/**
 * Props for the main Alert component. Combines root styling props with optional icon, title, and description content.
 *
 * @example
 *   ```jsx
 *   <Alert
