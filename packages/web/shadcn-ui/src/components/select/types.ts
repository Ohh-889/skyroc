...
/**
 * Class names for different slots in the select component. Allows customizing styles for content, items, scrolling
 * buttons, and other parts.
 */
export type SelectClassNames = Partial<Record<SelectSlots, ClassValue>>;

/** Props for the select content component. The dropdown panel that displays the selectable options. */
export interface SelectContentProps extends StyledComponentProps<_SelectContentProps> {
  ...
  /** Custom element to display as the scroll down button in the dropdown. Shown when the content is scrollable downward. */
  scrollDownButton?: React.ReactNode;
  /** Custom element to display as the scroll up button in the dropdown. Shown when the content is scrollable upward. */
  scrollUpButton?: React.ReactNode;
}

/**
 * Props for the select option item component. Represents a single selectable option in the dropdown menu.
 *
 * @example
 *   ```tsx
 *   <SelectItem
...
export interface SelectItemProps extends StyledComponentProps<_SelectItemProps>, SlotProps {
  ...
  /** Custom icon to display when the item is selected. Typically a checkmark or similar indicator. */
  indicatorIcon?: React.ReactNode;
}

/** Props for the select label/group header component. Used to group and label sets of related options. */
export interface SelectLabelProps extends StyledComponentProps<_SelectLabelProps> {}

/** Props for the select separator component. A visual divider between groups of options. */
export interface SelectSeparatorProps extends StyledComponentProps<_SelectSeparatorProps> {}

/**
 * Props for the select trigger component. The button that opens the dropdown when clicked.
 *
 * @example
 *   ```tsx
 *   <SelectTrigger
...
/**
 * Data structure for a single select option item. Represents an individual selectable choice in the dropdown.
 *
 * @example
 *   ```tsx
 *   {
...
/** Data structure for a separator option in the select dropdown. Used to visually separate groups of options. */
...
/**
 * Data structure for a group of related select options. Allows organizing options under a common label.
 *
 * @example
 *   ```tsx
 *   {
...
/** Union type representing any type of select option data. Can be an individual item, a group of items, or a separator. */
export type SelectOptionData = SelectOptionItemData | SelectGroupOptionData | SelectSeparatorOptionData;

/** Props for rendering a single select option. Used internally to render option items and groups. */
...
/**
 * Props for the main Select component. A searchable dropdown for selecting one or multiple values from a list.
 *
 * @example
 *   ```tsx
 *   <Select
...
export interface SelectProps
  ...
  /** Array of options to display in the dropdown. Can include individual items, groups, and separators. */
