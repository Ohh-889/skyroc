...
/**
 * Class names for different slots in the progress component. Allows customizing styles for specific parts of the
 * progress bar.
 */
export type ProgressClassNames = Partial<Record<ProgressSlots, ClassValue>>;

/**
 * Props for the Progress component. A visual indicator showing the progress of an operation or task.
 *
 * @example
