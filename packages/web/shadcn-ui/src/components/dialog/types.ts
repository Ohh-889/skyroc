...
/** Class names for different slots in the dialog component. Allows customizing styles for specific parts of the dialog. */
export type DialogClassNames = Partial<Record<DialogSlots, ClassValue>>;

/**
 * Props for the dialog close button component. Allows customizing the close button appearance and behavior.
 *
 * @example
 *   ```tsx
...
/** Props for the dialog content component. The main container that holds the dialog's content. */
export interface DialogContentProps extends StyledComponentProps<_DialogContentProps> {
  /**
   * Custom component to use instead of the default content wrapper. Allows complete customization of the content
   * container.
   */
  component?: ComponentType<_DialogContentProps>;
}

/** Props for the dialog description component. Accessible description text for screen readers. */
export interface DialogDescriptionProps extends StyledComponentProps<_DialogDescriptionProps> {
  /**
   * Custom component to use instead of the default description element. Useful for rendering description with custom
...
/**
 * Props for the dialog footer component. Container for action buttons (OK, Cancel, etc).
 *
 * @example
 *   ```tsx
 *   <DialogFooter>
...
/**
 * Props for the dialog header component. Container for the dialog title and optional close button.
 *
 * @example
 *   ```tsx
 *   <DialogHeader>
...
/** Props for the dialog overlay component. The background overlay that appears behind the dialog. */
export interface DialogOverlayProps extends StyledComponentProps<_DialogOverlayProps> {
  /**
   * Custom component to use instead of the default overlay element. Allows complete customization of the overlay
   * appearance.
   */
  component?: ComponentType<_DialogOverlayProps>;
}

/** Props for the dialog title component. The heading text displayed at the top of the dialog. */
export interface DialogTitleProps extends StyledComponentProps<_DialogTitleProps> {
  /**
   * Custom component to use instead of the default title element. Useful for using custom heading levels or styled
   * components.
   */
...
/**
 * Props for the main Dialog component. A modal dialog with header, content, and footer sections.
 *
 * @example
 *   ```tsx
 *   <Dialog
...
export interface DialogProps<
  T extends DialogContentProps = DialogContentProps
> extends StyledComponentProps<_DialogProps> {
  ...
  /**
   * Custom component to render the dialog content. Allows replacing the default content wrapper with a custom
   * implementation.
   */
  ...
  /** Description text displayed in the dialog. Provides context or additional information about the dialog action. */
  ...
  /**
   * Footer content, typically containing action buttons. Appears at the bottom of the dialog. Set to `null` to hide the
   * default footer.
   */
  ...
  /** Title text displayed at the top of the dialog. Should clearly indicate the purpose of the dialog. */
  title?: React.ReactNode;
  /** Props for the dialog title component. */
  titleProps?: DialogTitleProps;
  /** Element that triggers the dialog to open. Typically a button, but can be any interactive element. */
