...
/** Props for the Card root component. Main container for card content with size and layout options. */
export interface CardRootProps
  extends WithClassName, Omit<React.HTMLAttributes<HTMLDivElement>, 'className' | 'title'> {
...
/**
 * Props for the Card header component. Container for the card's top section, typically containing title and extra
 * content.
 */
...
/**
 * Props for the CardTitle root wrapper component. Container for the title and optional leading/trailing icons or
 * content.
 */
...
/** Props for the Card title component. Displays the main heading or title text of the card. */
...
/** Props for the Card footer component. Container for the card's bottom section, typically containing action buttons. */
...
/** Props for the Card content component. Main content area of the card. */
export interface CardContentProps
  extends WithClassName, Omit<React.HTMLAttributes<HTMLDivElement>, 'className' | 'title'> {
  /**
   * If true, the card content will be scrollable. When true, adds overflow-auto to the content wrapper.
   *
   * @default true
   */
  scrollable?: boolean;
...
/** Class names for different slots in the card component. Allows customizing styles for specific parts of the card. */
export type CardUi = Partial<Record<CardSlots, ClassValue>>;

/**
 * Props for the main Card component. A flexible container component that combines header, title, content, and footer
 * sections.
 *
 * @example
 *   ```jsx
...
export interface CardProps extends CardRootProps {
  ...
  /** Custom header content rendered at the top of the card. Overrides default header if provided. */
  header?: ReactNode;
