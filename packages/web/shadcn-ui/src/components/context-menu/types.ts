...
/** Props for the context menu arrow component. Displays a small arrow pointing to the trigger element. */
export type ContextMenuArrowProps = Omit<MenuArrowProps, 'component'>;

/** Props for the context menu content component. The container that holds menu items and appears on right-click. */
export type ContextMenuContentProps = Omit<MenuContentProps, 'arrowComponent' | 'component' | 'portalComponent'>;

/** Props for individual context menu item component. A selectable item in the context menu. */
export type ContextMenuItemProps = Omit<MenuItemProps, 'component'>;

/** Props for context menu label component. Non-interactive label for grouping menu items. */
export type ContextMenuLabelProps = Omit<MenuLabelProps, 'component'>;

/** Props for context menu option component. Base type for different option types (item, group, etc). */
...
/** Props for context menu item indicator component. Visual indicator for checked or selected menu items. */
export type ContextMenuItemIndicatorProps = Omit<MenuItemIndicatorProps, 'component'>;

/** Props for context menu separator component. Visual divider between menu items or groups. */
export type ContextMenuSeparatorProps = Omit<MenuSeparatorProps, 'component'>;

/** Props for context menu submenu content component. Container for nested submenu items. */
export type ContextMenuSubContentProps = Omit<MenuSubContentProps, 'component' | 'groupComponent' | 'portalComponent'>;

/** Props for context menu submenu trigger component. Clickable item that opens a submenu. */
export type ContextMenuSubTriggerProps = Omit<MenuSubTriggerProps, 'component'>;

/** Props for context menu checkbox item component. Menu item with checkbox functionality. */
export type ContextMenuCheckboxItemProps = Omit<MenuCheckboxItemProps, 'component' | 'indicatorComponent'>;

/** Props for context menu checkbox group component. Group of related checkbox items with mutual exclusivity control. */
...
/**
 * Props for context menu with checkbox items. Full context menu component supporting checkbox group functionality.
 *
 * @example
 *   ```tsx
 *   <ContextMenuCheckbox
...
/** Props for context menu radio item component. Menu item with radio button functionality. */
export type ContextMenuRadioItemProps = Omit<MenuRadioItemProps, 'component' | 'indicatorComponent'>;

/**
 * Props for context menu radio group component. Group of related radio items with mutual exclusivity (only one
 * selectable).
 */
...
/**
 * Props for context menu with radio items. Full context menu component supporting radio group functionality.
 *
 * @example
 *   ```tsx
 *   <ContextMenuRadio
...
/**
 * Props for the main ContextMenu component. A right-click context menu with support for nested items, checkbox groups,
 * and radio groups.
 *
 * @example
 *   ```tsx
