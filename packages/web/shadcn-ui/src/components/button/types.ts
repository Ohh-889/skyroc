...
/**
 * Props for the Button component. A versatile button element with support for variants, colors, loading states, and
 * icons.
 *
 * @example
 *   ```jsx
...
/**
 * Props for the ButtonGroup component. Container for grouping multiple buttons together with consistent spacing.
 *
 * @example
 *   ```jsx
...
/**
 * Props for the ButtonIcon component. A specialized button variant that displays primarily an icon with optional
 * leading/trailing content. Extends ButtonProps with icon-specific configuration.
 *
 * @example
 *   ```jsx
 *   <ButtonIcon
