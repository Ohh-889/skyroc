...
/** Props for the dropdown menu arrow indicator. The small arrow pointing toward the trigger element. */
export type DropdownMenuArrowProps = Omit<MenuArrowProps, 'component'>;

/** Props for the dropdown menu content container. Wraps the menu items and handles positioning and accessibility. */
export type DropdownMenuContentProps = Omit<MenuContentProps, 'arrowComponent' | 'component' | 'portalComponent'>;

/** Props for a dropdown menu item. Individual menu items that can be clicked to trigger actions. */
export type DropdownMenuItemProps = Omit<MenuItemProps, 'component'>;

/** Props for the dropdown menu label component. Non-interactive text used to group or label menu items. */
export type DropdownMenuLabelProps = Omit<MenuLabelProps, 'component'>;

/** Props for dropdown menu option data structure. Represents a configurable menu option with label, icon, and action. */
...
/** Props for the dropdown menu item indicator. Visual indicator for selected or checked menu items. */
export type DropdownMenuItemIndicatorProps = Omit<MenuItemIndicatorProps, 'component'>;

/** Props for the dropdown menu separator. Visual divider between menu item groups. */
export type DropdownMenuSeparatorProps = Omit<MenuSeparatorProps, 'component'>;

/** Props for the dropdown menu sub-content component. Container for nested/submenu items. */
export type DropdownMenuSubContentProps = Omit<MenuSubContentProps, 'component' | 'groupComponent' | 'portalComponent'>;

/** Props for the dropdown menu sub-trigger component. Trigger element that opens a submenu. */
export type DropdownMenuSubTriggerProps = Omit<MenuSubTriggerProps, 'component'>;

/** Props for dropdown menu checkbox item. Menu item with a checkbox indicator for boolean selections. */
export type DropdownMenuCheckboxItemProps = Omit<MenuCheckboxItemProps, 'component' | 'indicatorComponent'>;

/** Props for dropdown menu checkbox group. Group of checkbox items where multiple items can be selected. */
...
/**
 * Props for the main Dropdown Menu with checkbox group. A dropdown menu where items can be checked/unchecked
 * independently.
 *
 * @example
 *   ```tsx
...
/** Props for dropdown menu radio item. Menu item with a radio button indicator for mutually exclusive selections. */
export type DropdownMenuRadioItemProps = Omit<MenuRadioItemProps, 'component' | 'indicatorComponent'>;

/** Props for dropdown menu radio group. Group of radio items where only one item can be selected at a time. */
...
/**
 * Props for the main Dropdown Menu with radio group. A dropdown menu where only one item can be selected at a time.
 *
 * @example
 *   ```tsx
 *   <DropdownMenuRadio
...
/**
 * Props for the main Dropdown Menu component. A context menu triggered by an element with customizable items and
 * actions.
 *
 * @example
 *   ```tsx
