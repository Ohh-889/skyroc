...
/** Props for the List root component. Main container for list items. */
...
/** Props for the List item component. Individual list item container. */
...
/** Props for the List content component. Container for the main content area within a list item. */
...
/** Props for the List title component. Displays the title text within a list item. */
export interface ListTitleProps extends StyledComponentProps<ComponentPropsWithRef<'h3'>> {
  /** The size variant of the title text. */
  size?: ThemeSize;
}

/** Props for the List description component. Displays the description text within a list item. */
...
/** Class names for different slots in the list component. Allows customizing styles for specific parts of the list. */
export type ListUi = Partial<Record<ListSlots, ClassValue>>;

/**
 * Props for the main List component. A flexible list component that combines root, item, content, title, and
...
/** Props for the ListItemUI component. A composite list item with leading, content, and trailing areas. */
export interface ListItemUIProps extends Omit<ListItemProps, 'children' | 'content' | 'title'> {
  ...
  classNames?: ListUi;
  /** Main content area for the list item. Displayed after title and description. */
  content?: ReactNode;
  ...
  /**
   * Custom divider element to display between list items. If not provided, a default divider will be used when divider
   * is true.
   */
