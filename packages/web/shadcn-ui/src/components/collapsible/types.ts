...
/**
 * Props for the collapsible root component. Provides state management and interaction handling for the collapsible
 * element.
 */
export type CollapsibleRootProps = StyledComponentProps<Omit<_CollapsibleRootProps, 'content'>>;

/**
 * Props for the collapsible content component. The expandable/collapsible content area that shows or hides based on
 * state.
 */
export type CollapsibleContentProps = StyledComponentProps<_CollapsibleContentProps>;

/**
 * Class names for different slots in the collapsible component. Allows customizing styles for specific parts of the
 * collapsible.
 */
export type CollapsibleClassNames = Partial<Record<CollapsibleSlots, ClassValue>>;

/**
 * Props for the main Collapsible component. Controls the visibility of content with animation support.
 *
 * @example
 *   ```tsx
 *   <Collapsible
...
export interface CollapsibleProps extends CollapsibleRootProps {
  ...
  /** The content to display when the collapsible is expanded. Can be text, HTML elements, or any React node. */
  content?: React.ReactNode;

  /** Forces the content to always be mounted in the DOM. Enables animation control and prevents layout shifts. */
