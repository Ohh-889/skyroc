...
/** Type definition for the Carousel API instance. Provides access to carousel control methods and state. */
export type CarouselApi = UseEmblaCarouselType[1];

/** Parameters type for the useEmblaCarousel hook. Used to extract configuration and plugin types. */
export type UseCarouselParameters = Parameters<typeof useEmblaCarousel>;

/** Configuration options for the Embla carousel. Controls carousel behavior such as speed, alignment, and loop settings. */
export type CarouselOptions = UseCarouselParameters[0];

/** Plugin extensions for the Embla carousel. Allows adding custom functionality like autoplay or custom effects. */
export type CarouselPlugin = UseCarouselParameters[1];

/**
 * Root configuration properties for the carousel component. Defines the core settings and callbacks for carousel
 * initialization.
 */
export interface CarouselRootType {
  ...
  /**
   * Callback function to receive the carousel API instance. Allows programmatic control of the carousel.
   *
...
/** Context properties for the carousel component. Contains carousel state and control methods for child components. */
...
/** Class names for different carousel UI slots. Allows customizing styles for specific carousel parts. */
export type CarouselUi = Partial<Record<CarouselSlots, ClassValue>>;

/** Props for the carousel content wrapper component. Manages the layout and styling of slide items. */
...
/** Props for individual carousel item/slide component. Represents a single slide in the carousel. */
export type CarouselItemProps = HTMLComponentProps<'div'>;

/** Props for the carousel next navigation button. Extends button component properties. */
export type CarouselNextProps = ButtonProps;

/** Props for the carousel previous navigation button. Extends button component properties. */
export type CarouselPreviousProps = ButtonProps;

/** Props for the carousel root/container component. Combines HTML div properties with carousel configuration. */
export type CarouselRootProps = HTMLComponentProps<'div'> & CarouselRootType;

/** Base carousel props without children. Used as a foundation for carousel variants with different children types. */
...
/**
 * Carousel component with render function children. Allows dynamic slide generation based on slide index.
 *
 * @example
 *   ```tsx
...
export interface CarouselWithSlotChildren extends CarouselPropsWithoutChildren {
  /**
   * Render function that receives the slide index and returns ReactNode. Called for each slide to generate the content
   * dynamically.
   *
...
/**
 * Carousel component with array of children. Static list of slides passed as array elements.
 *
 * @example
 *   ```tsx
 *   <Carousel>
...
/**
 * Union type for carousel props supporting both children patterns. Choose between render function or array of slide
 * elements.
 */
