...
export interface VirtualizerList<
...
export interface VirtualizerGrid<
  TScrollElement extends HTMLDivElement = HTMLDivElement,
  TItemElement extends Element = Element
> extends Virtualizer<TScrollElement, TItemElement> {
...
export type VirtualizerBaseOptions<
  TScrollElement extends HTMLDivElement = HTMLDivElement,
  TItemElement extends Element = Element
> = PartialKeys<
...
export interface VirtualizerProps<T, TScrollElement extends HTMLDivElement, TItemElement extends Element> extends Omit<
  VirtualizerBaseOptions<TScrollElement, TItemElement>,
  'count' | 'estimateSize' | 'getScrollElement'
> {
...
export interface VirtualListProps<
  T,
  TScrollElement extends HTMLDivElement,
  TItemElement extends Element
> extends VirtualizerProps<T, TScrollElement, TItemElement> {
...
> extends VirtualizerProps<T, TScrollElement, TItemElement> {
  ...
  columnProps?: Omit<
    VirtualizerOptions<TScrollElement, TItemElement>,
    'count' | 'estimateSize' | 'getScrollElement' | 'horizontal'
  >;
  ...
  renderCell: (item: T, rowIndex: number, colIndex: number) => ReactNode;
