...
/**
 * Class names for different slots in the radio component. Allows customizing styles for specific parts of the radio
 * button and group.
 */
export type RadioClassNames = Partial<Record<RadioSlots, ClassValue>>;

/**
 * Props for the individual radio button component. Extends the base radio group item with additional styling and label
 * support.
 *
 * @example
 *   ```tsx
...
/**
 * Props for the radio group component containing multiple radio options. Manages the group selection state and renders
...
export interface RadioGroupProps extends StyledComponentProps<_RadioGroupProps> {
  ...
  /** Theme color applied to all radio buttons in the group. Affects the radio control and indicator colors. */
  color?: ThemeColor;
  /** Array of radio items to render in the group. Each item configuration is passed to individual Radio components. */
...
/** Props for the radio group item component. Represents a single selectable radio button within a group. */
export interface RadioGroupItemProps extends StyledComponentProps<_RadioGroupItemProps> {
  /** Theme color for this specific radio item. Overrides the group-level color if specified. */
  color?: ThemeColor;
  /**
   * Variant style for the radio.
   *
...
/** Props for the radio indicator component. The visual indicator element shown inside the radio control when selected. */
export interface RadioIndicatorProps extends StyledComponentProps<_RadioGroupIndicatorProps> {
  /** Theme color for the radio indicator element. Determines the fill color of the indicator dot. */
  color?: ThemeColor;
  /**
   * Variant style for the radio.
   *
...
/**
 * Props for the radio root container component. Provides a styled div wrapper for radio buttons with custom HTML
 * attributes.
 */
export interface RadioRootProps extends HTMLComponentProps<'div'> {}

/** Item configuration for RadioCardGroup. Extends RadioProps with icon and description for card display. */
...
/**
 * Props for the RadioCard component. A card-styled radio button with icon, label and description support.
 *
 * @example
 *   ```tsx
 *   <RadioCard
...
/**
 * Props for the RadioCardGroup component. A card-styled variant of RadioGroup with richer content display.
 *
 * @example
 *   ```tsx
 *   <RadioCardGroup
