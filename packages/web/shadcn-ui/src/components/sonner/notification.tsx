...
/** Notification configuration options Toast notification with title, description, icon, and optional buttons */
...
function showNotification(type: NotificationType | 'default', config: NotificationConfig): string | number {
  const {
    action,
    cancel,
    className,
