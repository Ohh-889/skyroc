...
/**
 * Props for the Label component. An accessible form label element that can be associated with form controls. Extends
 * the Radix UI label component with styling capabilities.
 *
 * @example
 *   // Basic label
