...
/**
 * Props for the Input component. A styled HTML input element with support for various input types and states.
 *
 * Extends standard HTML input attributes while omitting the native 'size' attribute to avoid conflicts with theme size
 * variants. Use className or style for sizing instead.
 *
 * @example
 *   ```tsx
 *   // Basic text input
