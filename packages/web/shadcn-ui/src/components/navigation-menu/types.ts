...
/**
 * Class names for different slots in the navigation menu component. Allows customizing styles for specific parts of the
 * navigation menu.
 */
export type NavigationMenuClassNames = Partial<Record<NavigationMenuSlots, ClassValue>>;

/** Class names for child link slots in the navigation menu. Customizes styling for nested navigation links. */
export type NavigationMenuChildLinkClassNames = Partial<Record<NavigationMenuSlots, ClassValue>>;

/**
 * Props for a NavigationMenuItem component. A menu item that can contain a submenu with child links.
 *
 * @example
...
/**
 * Props for a navigation menu link item. Represents a clickable link in the navigation menu.
 *
 * @example
 *   <NavigationMenuLink
 *     href="/docs"
...
export interface NavigationMenuLinkProps
  extends StyledComponentProps<Omit<_NavigationMenuLinkProps, 'asChild'>>, SlotProps {
...
/** Props for the NavigationMenuList component. Container for navigation menu items. */
export interface NavigationMenuListProps extends StyledComponentProps<_NavigationMenuListProps> {}

/** Props for the NavigationMenuRoot component. Main container that manages the navigation menu state and structure. */
export interface NavigationMenuRootProps extends StyledComponentProps<_NavigationMenuRootProps> {}

/**
 * Props for a NavigationMenuTrigger component. A button that opens/toggles the submenu content.
 *
 * @example
...
export interface NavigationMenuTriggerProps
  extends StyledComponentProps<Omit<_NavigationMenuTriggerProps, 'type'>>, SlotProps {
  /** Class names for customizing trigger slots */
  classNames?: Pick<NavigationMenuClassNames, 'trigger' | 'triggerIcon'>;
}

/**
 * Props for a child link in the navigation menu. Represents a link item within a navigation menu submenu.
 *
 * @example
...
/** Props for a child list in the navigation menu. Container for navigation menu child items. */
export interface NavigationMenuChildListProps extends HTMLComponentProps<'ul'> {}

/** Props for a child list item in the navigation menu. Individual container for child menu items. */
export interface NavigationMenuChildListItemProps extends HTMLComponentProps<'li'> {}

/** Props for the NavigationMenuContent component. Container for the expanded content of a navigation menu item. */
export interface NavigationMenuContentProps extends StyledComponentProps<_NavigationMenuContentProps> {}

/**
 * Props for the NavigationMenuIndicator component. Renders a visual indicator (arrow) showing the active menu item.
 *
 * @example
...
export interface NavigationMenuIndicatorProps extends Omit<
  StyledComponentProps<_NavigationMenuIndicatorProps>,
  'children'
> {
...
/** Props for the NavigationMenuViewport component. Container that displays the content of the active menu item. */
...
/** Base options for a navigation menu link. Represents a standalone link item without submenu. */
...
/** Base options for a navigation menu item. Provides common properties shared by items with different display modes. */
...
/** Union type for navigation menu item options. Can be a menu item with submenu or a standalone link. */
export type NavigationMenuItemOption = NavigationMenuItemBaseOption | NavigationMenuLinkBaseOption;

/**
 * Props for the main NavigationMenu component. A complex navigation component for site-wide or application navigation.
 *
 * @example
 *   <NavigationMenu
 *     items={[
