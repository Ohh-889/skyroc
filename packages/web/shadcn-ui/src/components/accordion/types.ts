...
/**
 * Class names for different slots in the accordion component. Allows customizing styles for specific parts of the
 * accordion.
 */
export type AccordionClassNames = Partial<Record<AccordionSlots, ClassValue>>;

/** Props for the accordion root component. Can be either single or multiple selection mode. */
export type AccordionRootProps =
  | StyledComponentProps<AccordionSingleProps>
  | StyledComponentProps<AccordionMultipleProps>;

/** Props for the accordion header component. Wraps the trigger button for each accordion item. */
export interface AccordionHeaderProps extends StyledComponentProps<_AccordionHeaderProps> {}

/** Props for the accordion content component. Contains the expandable/collapsible content for each item. */
export interface AccordionContentProps extends StyledComponentProps<_AccordionContentProps> {}

/** Props for the accordion item component. Represents a single expandable section in the accordion. */
export interface AccordionItemProps extends StyledComponentProps<_AccordionItemProps> {}

/** Props for the accordion trigger component. The clickable button that toggles the accordion item. */
...
/**
 * Data structure for a single accordion item when using the data-driven approach. Use this type to define items passed
 * to the `items` prop of the Accordion component.
 */
...
/**
 * Props for the main Accordion component. Supports data-driven rendering via the `items` prop.
 *
...
export type AccordionProps<T extends AccordionItemData = AccordionItemData> = AccordionRootProps & {
  ...
  /** Array of accordion items to render. Each item should have a unique `value` property. */
  items: T[];
