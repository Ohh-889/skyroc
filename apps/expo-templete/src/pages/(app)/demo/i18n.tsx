 ...
 * 国际化演示页。
 *
 * 四段分别对应模板在 i18n 上做的四个决定：切换与持久化、跟随系统、插值与复数、格式化统一入口。
 * 页面自身的文案也全部走词条——一个「讲 i18n 却自己写死中文」的演示页说服不了任何人。
 *
 * 注意整页**没有 loading 态**：词条是打包进来的，i18next 在模块顶层同步初始化完毕（见
 * `feature/i18n/i18n`），切语言也不是异步的。真要做成按需加载的词条，这里就得多一个骨架屏，
 * 那正是模板不那么做的原因。
 */
